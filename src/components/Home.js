...
const Home = () => {
    ...
    const jmt = <svg className='text-slate-500 mt-[37px]' stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="300px" width="300px" xmlns="http://www.w3.org/2000/svg">
    ...
    const board = <svg className='text-slate-500 mt-[70px] mb-[42px]' stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 384 512" height="225px" width="225px" xmlns="http://www.w3.org/2000/svg">
    ...
    const question = <svg className='text-slate-500 mt-[50px] mb-[38px]' stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="250px" width="250px" xmlns="http://www.w3.org/2000/svg">
