...
const Nav = () => {
    ...
    const manageIn = useRef(null);

    const settings = <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg">
    ...
    const logout = <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg">
    ...
    const members = <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg">
    ...
    const testFunc = () => {
        console.log(manageSel.current.value, manageIn.current.value);
    }
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-xl p-2 rounded w-auto font-Pretendard">
                    <div className='flex flex-col justify-center items-center gap-[20px] w-[800px] h-[400px]'>
                        <div className='flex flex-row justify-center items-center gap-[20px]'>
                            ...
                            <select ref={manageSel} className='text-[16px] text-slate-500 border-slate-300 rounded' onChange={manageSelChange} defaultValue='1'>
                                <option value='1'>계정명/사용자명</option>
                                <option value='2'>비활성화</option>
                                <option value='3'>계정정지</option>
                            </select>
                            {manageInTag}
                            <button className='bg-green-200 text-slate-400 hover:bg-green-400 hover:text-white text-[18px] font-[700] w-[70px] h-[45px] rounded' onClick={testFunc}>
                                검색
                            </button>
                        </div>
                        <div className='bg-red-50 overflow-auto w-[700px] h-[300px]'>
